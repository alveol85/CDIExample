...
//		Greeting saludos = new InformalGreeting();
//		Greeting saludos2 = new Greeting();
//		String nombre = "Alexander";
//		System.out.println(saludos.greet(nombre));
//		System.out.println(saludos2.greet(nombre));
		...
		//
		// System.out.println(bi.andThen(f).andThen(f).apply("java2s.com", "
		// tutorial"));
...
//
//		List<CasaDTO> sector1 = Arrays.asList(
//				new CasaDTO("cra 49", "manchester", "integral", "segundo", 2, 1),
